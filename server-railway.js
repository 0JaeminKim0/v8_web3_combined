...
const projects = [
  {
    ...
    tenor: '18-36 months',
    riskLevel: 'Low',
    description: 'Seed potato cultivation and processing in Northern Thailand with indexed offtake contracts and pre‑agreed volumes. Revenue from crop sales funds monthly USDT distributions after first 12 months.',
    keyFeatures: ['Multi-site Weather Protection', 'Indexed Offtake Contracts', '3M+ Operating Reserve', 'Quality Grade Standards', 'EAS Monthly Attestations'],
    image: 'https://readdy.ai/api/search-image?query=Professional%20potato%20farming%20operation%20in%20northern%20Thailand%20with%20systematic%20cultivation%20rows%2C%20modern%20agricultural%20facility%20showing%20organized%20potato%20fields%20with%20irrigation%20systems%20and%20farming%20equipment%2C%20commercial%20scale%20seed%20potato%20production%20with%20mountain%20landscape%20background&width=600&height=300&seq=ptf_improved_v2&orientation=landscape',
    investors: '18',
    ...
    templates: [
      {
        ...
        minAmount: '10.0',
        maxAmount: '100.0',
        terms: ['18 months', '36 months'],
        targetAPYRange: { min: 14.8, max: 14.8 },
        features: ['Multi-site Weather Protection', 'Indexed Offtake Contracts', '3M+ Operating Reserve', 'Quality Grade Standards', 'EAS Monthly Attestations'],
        sector: 'Agriculture',
        region: 'Thailand',
        riskLevel: 'Low',
        currency: 'USDT'
      },
      {
        ...
        features: ['Company Registration Complete', 'Base Design Approved', 'Legal DD Cleared', 'Medical Tourism Focus', 'Staged Capital'],
        sector: 'Healthcare',
        region: 'Thailand',
        riskLevel: 'Medium',
        currency: 'USDT'
      },
      {
        ...
        features: ['Revolving Facility', 'First‑Loss Reserve', 'PO Assignments', 'Established Buyers'],
        sector: 'Healthcare',
        region: 'Thailand',
        riskLevel: 'Low',
        currency: 'USDT'
